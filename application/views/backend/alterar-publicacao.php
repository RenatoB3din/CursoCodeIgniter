 <div id="page-wrapper">
            ...
            <div class="row">
                            ...
                            <div class="row">
                                <div class="col-lg-12">
                                   ...
                                   <div class="form-group">
                                        ...
                                        <input type="text" id="txt-titulo" name="txt-titulo" class="form-control" placeholder="Digite o titulo do usuário..." value="<?php echo $publicacao->titulo; ?>">
                                    </div>
                                    <div class="form-group">
                ...
                <div class="col-lg-6">
                    <div class="panel panel-default">
                        <div class="panel-heading">
                           <?php echo 'Imagem de destaque da '.$subtitulo.'' ?>
                        </div>
                        <style type="text/css">
                            img{width: 450px;};
                        </style>
                        <div class="panel-body">
                            <div class="row" style="padding-bottom: 1.6rem;">
